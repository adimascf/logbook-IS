...
by using niave counting, eris from gfa and fasta have the same number identified IS. But the number of IS from both files are detected 49 IS more.. are some IS detected more than one?
...
Two copies IS1397 elements in the genome are fragmented into six contigs, and all of them is identified separetely by Eris: ![IS1397 elements are fragmented into contigs](pictures/IS1397.png)
...
Two copies ISEc52 elements in the genome are fragmented into five contigs, and all of them is identified separetely by Eris: ![one IS1397 copy is fragmented into three contigs](pictures/ISEc52-all.png)
